...
set(Qt5Enginio_VERSION_STRING 1.0.6)
...
if (NOT TARGET Qt5::Enginio)
    ...
    set(Qt5Enginio_PRIVATE_INCLUDE_DIRS
        "${_qt5Enginio_install_prefix}/include/Enginio/1.0.6"
        "${_qt5Enginio_install_prefix}/include/Enginio/1.0.6/Enginio"
    )
    ...
    foreach(_module_dep ${_Qt5Enginio_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                1.0.6 ${_Qt5Enginio_FIND_VERSION_EXACT}
    ...
    _populate_Enginio_target_properties(RELEASE "libQt1Enginio.so.1.0.6" "" )
